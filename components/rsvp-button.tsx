...
>
  <svg
    viewBox="0 0 24 24"
    className="h-5 w-5 text-[#C9A35F] transition-transform duration-300 group-hover:scale-110"
    fill="currentColor"
    aria-hidden="true"
  >
  ...
  <span className="font-serif text-lg text-[#6B5A49] transition-colors group-hover:text-[#C9A35F]">
    RSVP via WhatsApp
  </span>
</button>
  )
