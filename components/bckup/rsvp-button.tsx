...
export function RsvpButton() {
  ...
  return (
    <button
      type="button"
      onClick={open}
      className="group relative mt-9 inline-flex items-center gap-2.5 overflow-hidden rounded-full border border-gold/50 px-9 py-3.5 text-[#FAF6EF] shadow-[0_10px_30px_-12px_rgba(107,90,73,0.55)] transition-transform duration-300 hover:scale-[1.03] active:scale-95"
